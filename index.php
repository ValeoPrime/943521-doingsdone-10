    ...
    <div class="container container--with-sidebar">
        ...
        <div class="content">
            <section class="content__side">
                ...
                $index=0;
                $number_count=count($projects);
                ?>
                <?php while($index<$number_count): ?>
                ...
                <table class="tasks">
                    ...
                    <?php foreach($tasks as $key=>$value): ?>
                        <tr class="tasks__item task
                            <?php $task_completed=$value["completed"];
                            if ($task_completed==="Да"): ?>
                                task--completed
                            <?php endif ?>
                            <?php if ($task_completed==="Да" and $show_complete_tasks===0 ): ?>
                                 visually-hidden
                            <?php endif ?>
                            ?>
                            ">
